namespace MapperUI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Items and tooltip are filled at load from the target registry and the relocation target's
            // own coupler: a controller list or a component list written here could only fall behind
            // device.yml. See MainForm.PopulateDeviceColumn.
